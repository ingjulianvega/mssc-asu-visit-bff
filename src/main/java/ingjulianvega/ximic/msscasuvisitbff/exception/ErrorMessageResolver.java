...
import ingjulianvega.ximic.msscasuvisitbff.configuration.VisitBffParameters;
...
public class ErrorMessageResolver {
    ...
    private final VisitBffParameters visitBffParameters;
    ...
    public ApiError resolveException(final String key) {
        ...
        return ApiError.builder().code(visitBffParameters.getPrefix() + errorArr[0]).description(errorArr[1]).build();
    }

    private ApiError getApiGenericError() {
        final String message = "UNKNOWN ERROR";
        return ApiError.builder()
                .code(visitBffParameters.getPrefix() + "500:199")
                .description(message)
                .build();
    }
}
